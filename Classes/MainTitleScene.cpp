...
bool MainTitleScene::init()
{
	...
	*/
	...
	for (int i = 0; i < buttonNum; ++i)
	{
		...
		auto tempRect = buttonItem0->getBoundingBox();
		auto tempWidth = tempRect.getMaxX() - tempRect.getMinX();
		buttonItem0->setPosition(Vec2(origin.x + visibleSize.width -50- tempWidth /2,
		...
		buttonBg->setPosition(Vec2(origin.x + visibleSize.width - 50 - tempWidth /2,
			origin.y + visibleSize.height - Config::titleHeight - visibleSize.height*0.2) / buttonNum*(5-i));
